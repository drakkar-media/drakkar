...
func TestImportURLEndpointSkipsRecentlyDispatchedURL(t *testing.T) {
	...
	router := Router(statusStub{}, queueSvc, workflowSvc, nil, nil, nil, nil, nil, nil, nil, NewEventBroker(), nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil)
...
func TestWorkflowEndpoints(t *testing.T) {
	...
	router := Router(statusStub{}, queueSvc, workflowSvc, pub, maint, cacheSvc, subtitles, blocklist, probes, nil, NewEventBroker(), nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil)
...
func TestRequestProfileEndpoint(t *testing.T) {
	...
	router := Router(statusStub{}, nil, nil, nil, nil, nil, nil, nil, nil, nil, NewEventBroker(), nil, nil, profiles, nil, nil, nil, nil, nil, nil, nil, nil, nil)
...
func TestManualBlocklistCreateEndpoint(t *testing.T) {
	...
	router := Router(statusStub{}, nil, nil, nil, nil, nil, nil, blocklist, nil, nil, NewEventBroker(), nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil)
...
func TestPrivacyStatusAndTestEndpoints(t *testing.T) {
	...
	router := Router(statusStub{}, nil, nil, nil, nil, nil, nil, nil, nil, nil, NewEventBroker(), nil, nil, nil, nil, nil, nil, nil, nil, mgr, nil, nil, nil, nil)
