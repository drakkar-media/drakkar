...
func buildRAR5EncryptedArchive(t *testing.T, password, fileName string, fileContentPlaintext []byte) []byte {
	t.Helper()
...
func TestInspectRAR5DecryptsHeadersAndAcceptsEncryptedStoredEntryWithCorrectPassword(t *testing.T) {
	...
	raw := buildRAR5EncryptedArchive(t, "correct-password", "Movie.mkv", plaintext)
